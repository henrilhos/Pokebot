...
{
    internal class GoldSilverActionRunner : CommonActionRunner
    {
        public GoldSilverActionRunner(ApiContainer apiContainer, IGameMemory gameVersion) : base(apiContainer, gameVersion)
        {
        }
